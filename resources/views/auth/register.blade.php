...
<head>
    ...
    <title>{{ __('Register') }} - Glomart CRM</title>
...
<body class="min-h-screen bg-gradient-custom flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-2xl">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-accent-light text-lg">{{ __('Create Your Account') }}</p>
        </div>

        <!-- Registration Form Card -->
        <div class="glass-effect rounded-2xl shadow-2xl p-8">
            <div class="text-center mb-6">
                                <h2 class="text-2xl font-bold text-white mb-2">{{ __('Join Glomart') }}</h2>
                <p class="text-accent-light">{{ __('Start managing your real estate business') }}</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-6">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-accent mb-4 flex items-center">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <!-- Company Name -->
                        <div>
                            <label for="company_name" class="block text-sm font-medium text-accent-light mb-2">
                                {{ __('Company Name') }}
                            </label>
                            <input 
                                type="text" 
                        ...
                        <!-- Company Email -->
                        <div>
                            <label for="company_email" class="block text-sm font-medium text-accent-light mb-2">
                                {{ __('Company Email') }}
                            </label>
                            <input 
                                type="email" 
                        ...
                        <div class="md:col-span-2">
                            <label for="company_phone" class="block text-sm font-medium text-accent-light mb-2">
                                {{ __('Company Phone') }}
                            </label>
                            <input 
                                type="text" 
                ...
                <div>
                    <h3 class="text-lg font-semibold text-accent mb-4 flex items-center">
                        <i class="fas fa-user mr-2"></i>{{ __('Administrator Account') }}
                    </h3>
                    
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <!-- Full Name -->
                        <div>
                            <label for="name" class="block text-sm font-medium text-accent-light mb-2">
                                {{ __('Full Name') }}
                            </label>
                            <input 
                                type="text" 
                        ...
                        <!-- Confirm Password -->
                        <div>
                            <label for="password_confirmation" class="block text-sm font-medium text-accent-light mb-2">
                                {{ __('Confirm Password') }}
                            </label>
                            <input 
                                type="password" 
            ...
            <div class="mt-6 text-center">
                <p class="text-accent-light">
                    ...
                    <a href="{{ route('login') }}" class="text-accent hover:text-white font-medium transition-colors">
                        {{ __('Sign In') }}
                    </a>
                </p>
            </div>
